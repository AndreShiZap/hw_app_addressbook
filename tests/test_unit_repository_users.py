...
class TestAsyncUser(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_create_user(self):
        body = UserSchema(username='test_user', email='email@example.com', password="qwerty")
    ...
    async def test_update_user_password(self, mock_get_user_by_email):
        user = User(id=1, username='test_user', email='email@example.com', password="qwerty", confirmed=True)
