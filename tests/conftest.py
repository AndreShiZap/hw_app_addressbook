...
#     app.dependency_overrides[FastAPILimiter.redis] = lambda: mock_redis
#     print(f"FastAPILimiter.redis initialized: {FastAPILimiter.redis}")
#     yield mock_redis
#
#     await FastAPILimiter.close()
#     print(f"FastAPILimiter.redis closed: {FastAPILimiter.redis}")